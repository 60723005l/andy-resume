...
const Informations: Array<IMediaThemeProps> = [
    {
        title: 'GIS工程師',
        subtitle: '杰悉科技股份有限公司 2年',
        content: `GIS 3D網頁圖台開發，包括前端與後端之開發流程。工作主要在網頁前端，使用Cesium.js + Vue.js 框架，開發過程涉及Vue元件設計、Cesium library使用、少許電腦圖學應用、3D Model前處理、空間資料處理、以及架設GIS的後端服務。具備單元測試、TDD、Scrum等經驗`,
        image: "/image/NADI-logo.gif"
    },
    {
        title: '系統分析師',
        subtitle: '資拓宏宇國際股份有限公司 1年',
